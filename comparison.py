...
fine_tuned_model = "ft:gpt-3.5-turbo-0125:personal:device-control-2:9H5GjgNF"
...
print('Fine-tuned model output: ',ask_function_calling(fine_tuned_model, user_query))